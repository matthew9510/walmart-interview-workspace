...
const Footer = () => {
  return (
    <div className="bg-[#004f9a] h-28 font-bold flex flex-col items-center justify-center text-center text-white">
      <p className="text-sm sm:text-base md:text-base mt-3 pb-2">This Product was made by Matthew Hess using <span className="text-lg sm:text-xl md:text-2xl">🪄</span></p> 
